...
The model was then performed on the test set for cross validation.  The accuracy on the test set was high at 0.996 and an expected out of sample error rate of 0.004 or 0.04%.
